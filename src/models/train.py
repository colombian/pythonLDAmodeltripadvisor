...
def coherence_model(model, lemma:List[List[str]], id2word): # -> gensim.CoherenceModel:
...
def train(text: pd.DataFrame): # -> List[gensim.LdaModel,gensim.CoherenceModel,float]:
